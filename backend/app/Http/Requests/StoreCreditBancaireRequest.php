...
class StoreCreditBancaireRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'montant_principal' => 'required|numeric|min:0.01|max:999999999.99',
    ...
    public function messages(): array
    {
        return [
            ...
            'montant_principal.required' => 'Le montant principal est obligatoire.',
            'montant_principal.min' => 'Le montant doit être supérieur à 0.',
