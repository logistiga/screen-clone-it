...
<tr>
    <td style="padding: 32px 40px;">
        ...
        <p style="color: #4a5568; font-size: 15px; line-height: 1.7; margin: 0 0 20px 0;">
            Nous vous confirmons la prise en charge de votre ordre de travail. Notre équipe s'engage à vous fournir un service de qualité dans les meilleurs délais.
        </p>
