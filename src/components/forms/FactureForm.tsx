...
export function FactureForm({ open, onOpenChange, onSubmit }: FactureFormProps) {
  ...
  // Set default echeance date (30 days from now)
  useEffect(() => {
    if (open) {
      const date = new Date();
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              placeholder="Conditions de paiement ou remarques..."
              rows={3}
            />
          </div>
