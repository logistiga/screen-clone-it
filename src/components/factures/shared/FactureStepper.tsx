...
import { Check, Container, Users, FileText, Eye, Ship, Package, Truck, Receipt } from "lucide-react";
...
const steps = [
  { id: 1, name: "Catégorie", icon: Container, description: "Type de facture" },
  { id: 2, name: "Client", icon: Users, description: "Sélection client" },
  { id: 3, name: "Détails", icon: FileText, description: "Lignes & prestations" },
  { id: 4, name: "Récapitulatif", icon: Eye, description: "Vérification" },
];

export function FactureStepper({ currentStep, categorie, onStepClick }: FactureStepperProps) {
