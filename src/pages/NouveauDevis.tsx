...
import { ArrowLeft, Ship, Container, Package, Truck, Forklift, Warehouse, Users, FileText, Plus, Trash2, Save, MapPin, ArrowLeftRight, Calendar } from "lucide-react";
...
type CategorieDevis = "conteneurs" | "conventionnel" | "operations_independantes";
...
const categoriesLabels: Record<CategorieDevis, { label: string; description: string; icon: React.ReactNode }> = {
  conteneurs: {
    label: "Conteneurs",
...
export default function NouveauDevisPage() {
  ...
  const [categorie, setCategorie] = useState<CategorieDevis | "">("");
  ...
  // Reset catégorie
  const handleCategorieChange = (value: CategorieDevis) => {
    setCategorie(value);
    setTypeOperation("");
            ...
            <Card>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {(Object.keys(categoriesLabels) as CategorieDevis[]).map((key) => {
