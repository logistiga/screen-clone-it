      ...
      >
        <div className="w-full max-w-md space-y-8">
          ...
          >
            ...
            <p className="text-white/80">Connectez-vous à votre espace LOJISTIGA</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-xs text-white/60">© {new Date().getFullYear()} LOJISTIGA - Tous droits réservés</p>
          </motion.div>
        </div>
      </motion.div>
