...
import { ArrowLeft, Ship, Container, Package, Truck, Forklift, Warehouse, Users, FileText, Plus, Trash2, Save, MapPin, ArrowLeftRight, Calendar, Receipt } from "lucide-react";
...
type CategorieFacture = "conteneurs" | "conventionnel" | "operations_independantes";
...
const categoriesLabels: Record<CategorieFacture, { label: string; description: string; icon: React.ReactNode }> = {
  conteneurs: {
    label: "Conteneurs",
...
export default function NouvelleFacturePage() {
  ...
  const [categorie, setCategorie] = useState<CategorieFacture | "">("");
  ...
  // Reset catégorie
  const handleCategorieChange = (value: CategorieFacture) => {
    setCategorie(value);
    setTypeOperation("");
      ...
      <div className="container py-6">
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Card>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {(Object.keys(categoriesLabels) as CategorieFacture[]).map((key) => {
          ...
          {categorie && (
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">Conditions de paiement</CardTitle>
              </CardHeader>
              <CardContent>
                <Textarea
                  value={notes}
